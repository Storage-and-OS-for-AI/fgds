...
/*
 * Example using fgds on NVIDIA/CUDA
 *
 ...
 *
 * Build: nvcc -O2 -I../module -o cuda_example cuda_example.cc -lcuda
 * Run:   ./cuda_example <gpu_id> <file_path>
...
int main(int argc, char *argv[])
{
    ...
    /* Get the GPU PCI BDF and derive the fgds node */
    ...
    /* Export the GPU buffer as a dma-buf fd via the CUDA driver API */
    cuInit(0);
    ...
    reg.dmabuf_offset = 0;
    reg.size = BUF_SIZE;
    /* Register dmabuf_fd in fgds. MAP_POPULATE installs pages up front */
